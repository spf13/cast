...
func baseToAny[T cast.Integer](fn func(any, int) T) func(any, int) any {
	return func(i any, b int) any { return fn(i, b) }
}

func baseToAnyErr[T cast.Integer](fn func(any, int) (T, error)) func(any, int) (any, error) {
...
var numberContexts = map[string]numberContext{
	"int": {
		...
		base:        baseToAny(cast.ToIntegerBase[int]),
		baseErr:     baseToAnyErr(cast.ToIntegerBaseE[int]),
	...
	"int8": {
		...
		base:        baseToAny(cast.ToIntegerBase[int8]),
		baseErr:     baseToAnyErr(cast.ToIntegerBaseE[int8]),
	...
	"int16": {
		...
		base:        baseToAny(cast.ToIntegerBase[int16]),
		baseErr:     baseToAnyErr(cast.ToIntegerBaseE[int16]),
	...
	"int32": {
		...
		base:        baseToAny(cast.ToIntegerBase[int32]),
		baseErr:     baseToAnyErr(cast.ToIntegerBaseE[int32]),
	...
	"int64": {
		...
		base:        baseToAny(cast.ToIntegerBase[int64]),
		baseErr:     baseToAnyErr(cast.ToIntegerBaseE[int64]),
	...
	"uint": {
		...
		base:        baseToAny(cast.ToIntegerBase[uint]),
		baseErr:     baseToAnyErr(cast.ToIntegerBaseE[uint]),
	...
	"uint8": {
		...
		base:        baseToAny(cast.ToIntegerBase[uint8]),
		baseErr:     baseToAnyErr(cast.ToIntegerBaseE[uint8]),
	...
	"uint16": {
		...
		base:        baseToAny(cast.ToIntegerBase[uint16]),
		baseErr:     baseToAnyErr(cast.ToIntegerBaseE[uint16]),
	...
	"uint32": {
		...
		base:        baseToAny(cast.ToIntegerBase[uint32]),
		baseErr:     baseToAnyErr(cast.ToIntegerBaseE[uint32]),
	...
	"uint64": {
		...
		base:        baseToAny(cast.ToIntegerBase[uint64]),
		baseErr:     baseToAnyErr(cast.ToIntegerBaseE[uint64]),
